...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    isCheckedList = List.filled(Boxes.getData().length, false);
  }
  ...
  @override
  Widget build(BuildContext context) {
    int numChecked = isCheckedList.where((data) => data== true).length;
    var progress = numChecked / Boxes.getData().length;
                ...
                Container(
                  ...
                  child: ValueListenableBuilder<Box<NoteModel>>(
                    ...
                    builder: (context, box, _) {
                      ...
                      // List<bool> isCheckedList = List.filled(box.length, false);
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                        hintText: 'Enter a Note', border: OutlineInputBorder()),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
